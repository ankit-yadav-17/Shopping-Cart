...
//this shows error if we click on the cart without login or signup
...
//this shows error if we click on shop without login or signup
document.getElementById("shop").addEventListener('click',() => {
    errordiv.innerText = "ERROR : Please login or signup to view your shop"
    setTimeout(() =>{
        errordiv.innerText = "";
    },5000);
})

//this shows error if we click on profile without login or signup
